const translations = {
  ...
  ja: {
    ...
    bio_wang_text:
      "王 森レイ博士は2014年に九州工業大学で博士（情報工学）を取得し、本プロジェクトを主導しています。ディペンダブルコンピュータシステム、VLSIテスト・故障診断、リコンフィギュラブルコンピューティング、ハードウェアセキュリティ、機械学習を活用したテスト・信頼性技術を研究してきました。これらのシステム研究を基盤に、環境モデリング、検証可能なAIエージェント計画、ロボットシミュレーション、産業現場実証をつなぐデジタルツイン／Physical AI基盤を開発しています。",
    bio_takahashi_role: "プロジェクトディレクター / コンピュータシステム",
    bio_takahashi_text:
      "高橋寛教授は愛媛大学副学長、電子情報通信学会（IEICE）フェローであり、本プロジェクトのディレクターを務めています。コンピュータシステムの設計・テスト、VLSIの故障検査・診断、ディペンダブル／フォールトトレラントコンピューティング、リコンフィギュラブルロジック、ハードウェアセキュリティに関する長年の研究実績を持ちます。本プロジェクトでは、信頼できる計算機システム、形式検証、デジタルツイン、産業ロボティクスを統合するための学術的・システム的リーダーシップを担っています。",
  ...
  zh: {
    ...
    bio_wang_text:
      "王森岭博士于2014年获得九州工业大学信息工学博士学位，并负责领导本项目。他长期研究可信计算机系统、VLSI测试与故障诊断、可重构计算、硬件安全，以及机器学习辅助的测试与可靠性技术。以这些系统研究为基础，他正在开发连接环境建模、可验证AI智能体规划、机器人仿真和工业现场验证的数字孪生与Physical AI平台。",
    bio_takahashi_role: "项目主任 / 计算机系统",
    bio_takahashi_text:
      "高桥宽教授现任爱媛大学副校长、电子信息通信学会（IEICE）会士，并担任本项目主任。他长期研究计算机系统设计与测试、VLSI故障测试与诊断、可信与容错计算、可重构逻辑和硬件安全。在本项目中，他为可靠计算、形式化验证、数字孪生与工业机器人技术的融合提供学术和系统层面的领导。",
